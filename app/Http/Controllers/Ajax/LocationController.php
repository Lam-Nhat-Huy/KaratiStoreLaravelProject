...
{
    /*CONTROLLER NÀY ĐƯỢC GỌI BẰNG AJAX Ở FILE location.js*/
    protected $provinceRepository;
    protected $districtRepository;

    public function __construct(DistrictRepository $districtRepository, ProvinceService $provinceRepository)
    {
